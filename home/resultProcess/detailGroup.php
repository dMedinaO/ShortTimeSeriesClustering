              ...
              <div id="page-content">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Statistic Summary</h3>
                        </div>
                        <div class="panel-body">
                          <table id="statisticalGroup" class="table table-striped table-bordered" cellspacing="0" width="100%">
                              <thead>
                                <tr>
